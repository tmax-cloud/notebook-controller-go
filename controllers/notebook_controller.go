...
// +kubebuilder:rbac:groups=hyperflow.tmax.io,resources=notebooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hyperflow.tmax.io,resources=notebooks/status,verbs=get;update;patch
